...
totaltime1 = [1, 1432.426/(2*852.303), 1432.426/(5*303.665), 1432.426/(12*140.389)]
totaltime2 = [1, 1613.82/(2*972.237), 1613.82/(5*341.157), 1613.82/(12*157.54)]
totaltime3 = [1, 2182.501/(2*1134.809), 2182.501/(5*441.792), 2182.501/(12*208.611)]
...
ylabel('Efficiency')
title('Comparison of MD5, SHA1, and SHA256 brute force efficiency OpenMP\non Intel Xeon CPU X5660 @ 2.80GHz 12288 KB Cache')
...
grid(True)
savefig("brute_force_3_char_efficiencyOPENMP.png")
show()
